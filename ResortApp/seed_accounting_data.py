...
def seed_data():
    ...
    try:
        ...
        for branch in branches:
            ...
            ledgers_data = [
                ("Room Tariff Income", "Sales Accounts", "Booking", "credit"),
                ("Restaurant Revenue", "Sales Accounts", "Food", "credit"),
                ("Spa & Wellness Revenue", "Sales Accounts", "Service", "credit"),
                ("Laundry Revenue", "Sales Accounts", "Service", "credit"),
                ("Event Revenue", "Sales Accounts", "Service", "credit"),
                ("Package Revenue", "Sales Accounts", "Booking", "credit"),
                ("CGST Payable", "Duties & Taxes", "GST", "credit"),
                ("SGST Payable", "Duties & Taxes", "GST", "credit"),
                ("IGST Payable", "Duties & Taxes", "GST", "credit"),
                ("CGST Input Credit", "Duties & Taxes", "GST", "debit"),
                ("SGST Input Credit", "Duties & Taxes", "GST", "debit"),
                ("IGST Input Credit", "Duties & Taxes", "GST", "debit"),
                ("Accounts Receivable", "Current Assets", "Booking", "debit"),
                ("Inventory Stock", "Current Assets", "Inventory", "debit"),
                ("Cash in Hand", "Cash-in-hand", "General", "debit"),
                ("Bank Account - Main", "Bank Accounts", "General", "debit"),
                ("Accounts Payable", "Current Liabilities", "Purchase", "credit"),
                ("Advance Deposits - Guests", "Current Liabilities", "Booking", "credit"),
                ("Cost of Goods Sold", "Direct Expenses", "Purchase", "debit"),
