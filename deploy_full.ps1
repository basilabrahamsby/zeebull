...
python3 ~/orchid-repo/extract_fixed.py ~/orchid-repo/backend_deploy.zip ~/orchid-repo
...
cd /var/www/inventory/ResortApp/ && sudo python3 fix_rental_prices_by_id.py
cd /var/www/inventory/ResortApp/ && sudo python3 fix_payable_status.py
echo '[Backend] Running Database Migrations...'
cd /var/www/inventory/ResortApp/ && sudo python3 migrate_database.py
cd /var/www/inventory/ResortApp/ && sudo python3 create_activity_log_table.py
...
# python3 -m zipfile -e ~/orchid-repo/userend_deploy.zip ~/orchid-repo/userend_build
...
python3 -m zipfile -e ~/orchid-repo/dashboard_deploy.zip ~/orchid-repo/dashboard_build
# Target: /var/www/html/orchidadmin/
...
Write-Host "  Backend API: http://136.113.93.47:8011/api" -ForegroundColor Yellow
Write-Host "  Dashboard:   http://136.113.93.47/admin" -ForegroundColor Yellow
Write-Host "  User End:    http://136.113.93.47/resort" -ForegroundColor Yellow
