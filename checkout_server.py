    ...
    if payload.asset_damages:
        ...
        for asset in payload.asset_damages:
            ...
            if target_item_id and target_location_id:
                ...
                # Skip waste/damage logging if it's being sent to Laundry (treat as 'Dirty' not 'Waste')
                # Unless explicitly marked as waste
                is_laundry_damage = asset.is_damaged and (asset_is_laundry or (asset.return_location_id and not asset.is_waste))
                
                if asset.is_damaged and not is_laundry_damage:
                ...
                if asset_is_laundry and asset_laundry_id:
                    ...
                    if asset.request_replacement:
                         ...
                         db.add(new_sr)
                         print(f"[CHECKOUT] Created replacement request for laundry asset")
